...
def fix_unicode(data):
	...
	for line in data:
		...
		line = line.replace( u"\u2014".encode('utf8'), "---" )
		line = line.replace( u"\u2013".encode('utf8'), "--" )
		line = line.replace( u"\u2026".encode('utf8'), "|ldots|" )
		line = line.replace( u"\227".encode('utf8'), "--" )

		# Math Symbols
		line = line.replace( u"\xB7".encode('utf8'), "|cdot|" )
		line = line.replace( u"\xD7".encode('utf8'), "|times|" )
		line = line.replace( u"\xF7".encode('utf8'), "|div|" )
		line = line.replace( u"\u2212".encode('utf8'), "|-|" )
		line = line.replace( u"\u2213".encode('utf8'), "|pm|" )
		line = line.replace( u"\u221A".encode('utf8'), "|sqrt|" )
		line = line.replace( u"\u223C".encode('utf8'), "|tilde|" )
		line = line.replace( u"\u2248".encode('utf8'), "|approx|" )

		# Greek Math Symbols
		line = line.replace( u"\u0394".encode('utf8'), "|Delta|" )
		line = line.replace( u"\u0396".encode('utf8'), "|Zeta|" )
		line = line.replace( u"\u03B1".encode('utf8'), "|alpha|" )
		line = line.replace( u"\u03B2".encode('utf8'), "|beta|" )
		line = line.replace( u"\u03B3".encode('utf8'), "|gamma|" )
		line = line.replace( u"\u03B4".encode('utf8'), "|delta|" )
		line = line.replace( u"\u03B5".encode('utf8'), "|epsilon|" )
		line = line.replace( u"\u03BC".encode('utf8'), "|mu|" )
		line = line.replace( u"\u03C3".encode('utf8'), "|sigma|" )
		line = line.replace( u"\u03C6".encode('utf8'), "|phi|" )
		line = line.replace( u"\u03D5".encode('utf8'), "|varphi|" )
