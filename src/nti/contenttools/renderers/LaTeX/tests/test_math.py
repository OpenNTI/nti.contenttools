...
#===============================================================================
    ...
    def test_mover_check_2(self):
        ...
        mo_1 = MathRun()
        mo_1.element_type = 'operator'
        mo_1.add(TextNode(u'\u02C7', type_text=u'math'))
        mover_1.add(mo_1)
    ...
    def test_mover_ddot_2(self):
        ...
        mo_1 = MathRun()
        mo_1.element_type = 'operator'
        mo_1.add(TextNode(u'\u0308', type_text=u'math'))
        mover_1.add(mo_1)
    ...
    def test_mover_mathring_4(self):
        ...
        mo_1 = MathRun()
        mo_1.element_type = 'operator'
        mo_1.add(TextNode(u'\u0325', type_text=u'math'))
        mover_1.add(mo_1)
    ...
    def test_mover_tilde_3(self):
        ...
        mo_1 = MathRun()
        mo_1.element_type = 'operator'
        mo_1.add(TextNode(u'\u0303', type_text=u'math'))
        mover_1.add(mo_1)
    ...
    def test_mover_vec(self):
        ...
        math.add(mrow)
        output = render_output(math)
        assert_that(output, is_(u'\\[\\vec{x}\\]'))
